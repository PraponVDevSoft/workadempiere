...
public class X_M_Product_Brand extends PO implements I_M_Product_Brand, I_Persistent 
{
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_Product_Brand[")
	...
	/** Set Brand.
		@param M_Product_Brand_ID Brand	  */
	public void setM_Product_Brand_ID (int M_Product_Brand_ID)
	{
		if (M_Product_Brand_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_M_Product_Brand_ID, null);
		else 
