...
public class X_C_Billing extends PO implements I_C_Billing, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 25531229L;

    /** Standard Constructor */
    public X_C_Billing (Properties ctx, int C_Billing_ID, String trxName)
    {
      ...
      /** if (C_Billing_ID == 0)
        {
			...
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
// @SQL=SELECT C_DocType_ID FROM C_DocType WHERE Name = 'Billing'
			setDateBilled (new Timestamp( System.currentTimeMillis() ));
// @#Date@
			setDocAction (null);
// CO
			setDocumentNo (null);
    ...
    /** Load Constructor */
    public X_C_Billing (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_Billing[")
	...
	/** Set Billled Date.
		@param DateBilled Billled Date	  */
	public void setDateBilled (Timestamp DateBilled)
	{
		set_Value (COLUMNNAME_DateBilled, DateBilled);
	}
	...
	{
		return (Timestamp)get_Value(COLUMNNAME_DateBilled);
	}

	/** Set Cheque Received Date.
		@param DateChequeReceived Cheque Received Date	  */
	public void setDateChequeReceived (Timestamp DateChequeReceived)
	{
		set_Value (COLUMNNAME_DateChequeReceived, DateChequeReceived);
	}

	/** Get Cheque Received Date.
		@return Cheque Received Date	  */
	...
	/** Set Generate Billing Line.
		@param GenerateBillingLine Generate Billing Line	  */
	...
	/** Get Generate Billing Line.
		@return Generate Billing Line	  */
