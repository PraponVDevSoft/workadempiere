...
public class X_mp_matconline extends PO implements I_mp_matconline, I_Persistent 
{
	...
	/** Set mp_matconline ID.
		@param mp_matconline_ID mp_matconline ID	  */
	public void setmp_matconline_ID (int mp_matconline_ID)
	{
		if (mp_matconline_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_mp_matconline_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_mp_matconline_ID, Integer.valueOf(mp_matconline_ID));
	}

	/** Get mp_matconline ID.
		@return mp_matconline ID	  */
	public int getmp_matconline_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_mp_matconline_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
