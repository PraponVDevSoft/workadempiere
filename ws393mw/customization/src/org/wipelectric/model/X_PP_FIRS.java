...
/** Generated Model for PP_FIRS
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_PP_FIRS extends PO implements I_PP_FIRS, I_Persistent 
{
      ...
      /** if (PP_FIRS_ID == 0)
        {
			...
			setAD_WF_Node_ID (0);
			setC_DocType_ID (0);
// @SQL=SELECT C_DocType_ID FROM C_DocType WHERE Name = 'FIRS'
...
// DR
    ...
    /** Load Constructor */
    public X_PP_FIRS (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_FIRS[")
	...
	{
		throw new IllegalArgumentException ("Logo_ID is virtual column");	}
