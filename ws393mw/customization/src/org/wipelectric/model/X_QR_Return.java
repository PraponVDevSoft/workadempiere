...
/** Generated Model for QR_Return
 *  @author Adempiere (generated) 
 *  @version Release 3.9.3 - $Id$ */
public class X_QR_Return extends PO implements I_QR_Return, I_Persistent 
{
    ...
    {
      super (ctx, QR_Return_ID, trxName);
      /** if (QR_Return_ID == 0)
        {
			setC_BPartner_ID (0);
			setDocumentNo (null);
...
// N
    ...
    /** Load Constructor */
    public X_QR_Return (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_QR_Return[")
	...
	{
		if (QR_Return_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_QR_Return_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_QR_Return_ID, Integer.valueOf(QR_Return_ID));
	}
