...
public class VOrderIssue extends OrderIssue implements FormPanel,
	...
	private static CLogger log = CLogger.getCLogger(VOrderIssue.class);
	...
	private CPanel IssueOrder = new CPanel();
	...
	public void init(int WindowNo, FormFrame frame) {
		m_WindowNo = WindowNo;
		m_frame = frame;
		log.info("VOrderIssue.init - WinNo=" + m_WindowNo);
		...
		try {
			...
			log.log(Level.SEVERE, "VOrderIssue.init", e);
		}
	} // init
...
/*  lookup PP_Order */
		...
		orderField = new VLookup("PP_Order_ID", false, false, true, orderL);    //20191220
...
/*    */
	...
	private void jbInit() throws Exception {
		...
		IssueOrder.setLayout(new java.awt.BorderLayout());
		PanelCenter.setLayout(new java.awt.BorderLayout());
		issueScrollPane.setBorder(new javax.swing.border.TitledBorder(" Line "));   /* "" 4/2/2016  */
		issueScrollPane.setViewportView(issue);
		PanelCenter.add(issueScrollPane, java.awt.BorderLayout.CENTER);
		IssueOrder.add(PanelCenter, java.awt.BorderLayout.CENTER);
		Process.setText(Msg.translate(Env.getCtx(), "OK"));
		PanelBottom.add(Process);
		IssueOrder.add(PanelBottom, java.awt.BorderLayout.SOUTH);
		...
		IssueOrder.add(northPanel, java.awt.BorderLayout.NORTH);
		TabsReceiptsIssue.add(IssueOrder,
...
*/
		...
		if (e.getSource().equals(pickcombo)) {
			if (isOnlyReceipt()) {
				...
				enableToDeliver();  // disableToDeliver(); prapon 2020/01/13
				locatorLabel.setVisible(true);	/* false, prapon 20/12/2019 */
				locatorField.setVisible(true);	/* false, prapon 20/12/2019 */
	...
	public void vetoableChange(PropertyChangeEvent e)
		...
		log.fine("VOrderIssue.vetoableChange - " + name + "=" + value);
		if (value == null)
			return;
		...
		if (name.equals("PP_Order_ID")) {
			...
			if (pp_order != null) {
				...
				pickcombo.setSelectedIndex(1); // default to first entry -
												// isBackflush    default 0  prapon 2019/12/20
			}
		} // PP_Order_ID
	}
